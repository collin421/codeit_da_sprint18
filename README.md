...
- **응답 필드**: stationName, dataTime, pm10Value, pm25Value, sidoName 등 총 36개 필드 _(§1.1.다.3.c, Table 17 — 응답 메시지 명세)_
- **API 한도**: 초당 최대 50 TPS, 평균 응답 500ms _(§1.1.다.3.a, Table 15)_
- **에러 코드**: `22`(호출 한도 초과), `30`(서비스키 미등록) 등 _(§2 p.25, Table 30)_
